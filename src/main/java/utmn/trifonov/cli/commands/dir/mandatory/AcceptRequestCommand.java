...
public class AcceptRequestCommand extends Command {
    ...
    public AcceptRequestCommand(User executor, File location, String identifier) throws CommandExecutionException {
    ...
    public void process() throws CommandExecutionException {
        ...
        MandatoryDeleteRequest.accept(request, executor);
    }
